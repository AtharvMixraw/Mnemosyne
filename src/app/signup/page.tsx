            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex h-16 items-center justify-between">
                ...
                <div className="hidden items-center gap-8 md:flex">
                  <Link href="/login" className="flex h-9 items-center justify-center rounded-md bg-slate-200 px-4 text-sm font-semibold text-slate-800 transition-all duration-200 hover:bg-slate-300 hover:scale-105">
                    Log in
                  </Link>
                </div>
            ...
            <div className="w-full max-w-md space-y-8">
              <div className="animate-fade-in-down">
                ...
                <p className="mt-2 text-center text-sm text-slate-600 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                  to start sharing and preparing with peers
                </p>
              </div>
              ...
              <div className="mt-8 space-y-6 rounded-lg bg-white p-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-scale-in" style={{animationDelay: '0.4s'}}>
                <div className="space-y-4">
                  ...
                  <div className="animate-slide-in-left" style={{animationDelay: '1.0s'}}>
